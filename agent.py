...
class DQNAgent:
    ...
    def build_model(self):
        ...
        self.train = tf.compat.v1.train.AdamOptimizer(learning_rate=0.001).minimize(self.loss)
        # Summaries
    ...
    def save_model(self):
        ...
        self.saver.save(sess=self.session, save_path='./final_models/model', global_step=self.step)
